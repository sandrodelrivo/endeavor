...
data modify storage endeavour:monument objectives set value [{threshold: 500, reward: "reward_0"}, {threshold: 1000, reward: "reward_1"}, {threshold: 10000, reward: "reward_2"}]
